...
public class Evolution {
    ...
    private int popsize;
    private int indivLength;


    public Evolution(Random random, int popSize, int indivLength) {
        this.random = random;
        this.popsize = popSize;
        this.indivLength = indivLength;
        mutationClass = new Mutation(random, indivLength);
    ...
    private void init_population() {
        ...
        for (int i = 0; i < popsize; i++) {
            population[i] = new Individual(indivLength, random);
    ...
    private Individual[] generate_offspring() {
        ...
        for (int i = 0; i < 6; i++) {
            ...
            mutationClass.mutateGenes(offspring[i]);
            }
        return offspring;
    }
